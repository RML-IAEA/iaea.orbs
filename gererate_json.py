...
from utils import save_json, parse_dms_coordinates, load_json_data
...
class DataProcessor:
    ...
    def process_station(self, sample_type: str, sample_type_dir: str) -> None:
        ...
        for station in self.station_coord[sample_type]:
            ...
            for csv_file in listdir(sample_type_dir):
                if str(station["id"]) != self.get_id(csv_file):
                    continue
...
def main():
    ...
    save_json("stations/transformed/json/station_data.json", final_dict)
